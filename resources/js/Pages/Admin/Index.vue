    ...
    <AdministratorLayout>
        ...
        <div class="grid grid-cols-1 gap-6 mt-6 lg:grid-cols-2 xl:grid-cols-4">
            ...
            <div class="border rounded-lg shadow-sm">
                ...
                <p class="px-4 py-6 text-gray-600">
                    See and talk to your users and import them into your
                    platform.
                </p>
                <ul class="px-4 pb-4 space-y-4 divide-y">
                    ...
                    <li class="pt-4 text-sm font-medium text-gray-400">
                        <p>
                            ...
                            <a
                                href="#"
                                class="font-normal text-blue-500 hover:underline whitespace-nowrap"
            ...
            <div class="border rounded-lg shadow-sm xl:col-span-3">
                ...
                <div class="flex items-center p-4 space-x-4">
                    ...
                    <span
                        class="flex items-center px-2 space-x-2 text-sm text-green-800 bg-green-100 rounded"
                    >
                        <span>
                            <svg
                                viewBox="0 0 20 20"
